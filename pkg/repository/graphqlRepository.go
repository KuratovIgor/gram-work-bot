...
type GraphqlRepository interface {
	...
	SaveApplyToJob(userId string, vacancyName string, employer string, alternateUrl string, area string, status string, salaryFrom int, salaryTo int, date string) error
}
